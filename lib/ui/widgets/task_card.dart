...
class _TaskCardState extends State<TaskCard> {
  ...
  bool _deleteLoadingProgress = false;
      ...
      child: Container(
        ...
        child: ListTile(
          shape: RoundedRectangleBorder(
            ...
            title: Text(widget.taskModel.title, style: Theme.of(context).textTheme.titleMedium,),
            subtitle: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(widget.taskModel.description),
                SizedBox(height: 15,),
                Text('Date: ${widget.taskModel.formattedDate}'),
                Row(
                  children: [
                    Chip(
                    ...
                    }, icon: Icon(Icons.edit_note_outlined, color: Colors.green,size: 30,)),
                    IconButton(onPressed: (){
                      _deleteTask();
